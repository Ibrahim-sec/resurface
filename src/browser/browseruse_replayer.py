...
class BrowserUseReplayer:
    ...
    def _build_hunt_prompt(self, target_url: str, vuln_types: list[str]) -> str:
        ...
        return (
            ...
            "## Instructions\n"
            "1. Navigate to the target and explore all pages/forms/API endpoints\n"
            "2. Test appropriate payloads for each vuln type:\n"
            "   - XSS: <script>alert(1)</script>, <img src=x onerror=alert(1)> in inputs\n"
            "   - SQLi: ' OR 1=1--, ' UNION SELECT NULL-- in login/search forms\n"
